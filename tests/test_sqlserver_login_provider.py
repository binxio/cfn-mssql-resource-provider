...
class Event(dict):
    def __init__(self, request_type, login_name, physical_resource_id=None):
        self.update({
            ...
            'ResourceProperties': {
                'LoginName': login_name, 'Password': random_password(),
...
class SQLServerLoginTestCase(TestCase):
    ...
    def test_create_login(self):
        ...
        assert 'PhysicalResourceId' in response
        physical_resource_id = response['PhysicalResourceId']
        assert re.match(r'^sqlserver:localhost:1444:login:[0-9]+$', physical_resource_id)
    ...
    def test_all_updates(self):
        ...
        assert re.match(r'^sqlserver:localhost:1444:login:[0-9]+$', physical_resource_id_2)
    ...
    def test_password_parameter_use(self):
        ...
        try:
            ...
            event['ResourceProperties']['Server']['PasswordParameterName'] = dbowner_password_name
